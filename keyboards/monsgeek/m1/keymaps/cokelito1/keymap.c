...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAIN_LAYER] = LAYOUT_all( /* Base */
        ...
        KC_GRV,                   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,            KC_MINS, KC_EQL,   KC_BSPC,          KC_F16,
        KC_TAB,                   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,            KC_LBRC, KC_RBRC,  KC_BSLS,          KC_F17,
        MO(LATEX_LAYER),          KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,         KC_QUOT, KC_NUHS,  KC_ENT,           KC_F18,
        KC_LSFT,                  KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,          KC_SLSH,           KC_RSFT, KC_UP,   KC_F19,
    ...
    [LATEX_LAYER] = LAYOUT_all( /* Base */
        ...
        _______,                  _______,     _______,      _______, KC_CAPS, _______,    _______, KC_NTIL,             _______,             _______,              _______,              KC_QMIM,          _______, _______, TG(CONFIG_LAYER),
    ...
    [CONFIG_LAYER] = LAYOUT_all( /* Base */
        ...
        _______,         _______,     _______,      _______, _______, _______,    _______,    _______,    _______,    _______,    _______,    _______, _______, _______,          QK_UNICODE_MODE_WINCOMPOSE,
        _______,         _______,     _______,      _______, _______, _______,    _______,    _______,    _______,    _______,    _______,    _______, _______, _______,          QK_UNICODE_MODE_EMACS,
